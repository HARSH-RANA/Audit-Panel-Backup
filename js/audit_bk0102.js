            ...
            if(status=='success' && data['result'].length>0){
                ...
                if(data['result'].length){                    
                    ...
                    if(offset==1){
                        ...
                        var paginationHtml='<div class="dataTables_paginate paging_simple_numbers" id="auditFooterPagination" style="float:right"><ul class="pagination"><li class="paginate_button page-item '+disableClass+'" id="campaignListing_previous"><a onclick="getAuditTableData(1)" aria-controls="campaignListing" data-dt-idx="0" tabindex="0" class="page-link">First</a></li>';
                        ...
                        paginationHtml+='<li class="paginate_button page-item next '+disableClass+'" id="campaignListing_next"><a onclick="getAuditTableData('+ pageCount +')" aria-controls="campaignListing" data-dt-idx="4" tabindex="0" class="page-link">Last</a></li></ul></div>';
                    }else{ 
                        var disableClass=(offset==1)?"disabled":"";
                        var paginationHtml='<div class="dataTables_paginate paging_simple_numbers" id="auditFooterPagination" style="float:right"><ul class="pagination"><li class="paginate_button page-item '+disableClass+'" id="campaignListing_previous"><a onclick="getAuditTableData(1)" aria-controls="campaignListing" data-dt-idx="0" tabindex="0" class="page-link">First</a></li>';
