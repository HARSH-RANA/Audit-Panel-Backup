...
$('#salesreportrange span').html(startdate.format('DD/MM/YYYY') + ' - ' + enddate.format('DD/MM/YYYY'));
$('#salesreportrange').daterangepicker({
    ...
    ranges: {
        ...
        $('#salesreportrange span').html(start.format('DD/MM/YYYY') + ' - ' + end.format('DD/MM/YYYY'));
